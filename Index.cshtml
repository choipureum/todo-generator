...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-134051594-4"></script>
...
<body>
    ...
    <div class="container">
        <div class="hero">
            <h1><span class="title-identifier">랜덤 할 일</span> 생성기</h1>
            <p>랜덤으로 <span class="title-identifier">랜덤으로 할 일을</span> 생성합니다.</p>
        </div>
        <div class="form">
            <!--
            ...
            <div class="wrapper">
                <div class="form-8bit">
                    <div class="form-8bit-wrapper">
                        <div type="button" class="form-component button" @@click="makeBoring()" />생성!
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="github-wrapper"><div class="form-8bit"><div class="form-8bit-wrapper"><div class="github"><a href="./detail.html" target="_blank">대체 여긴 뭐하는 사이트인가요?</a></div></div></div></div>

    <script type="text/javascript">
        var client_id = 'cNe5P6_kfag5VUKmquv0';
        var client_secret = 'yTN5A_ULs0';
